...
- AppMetrica SDK for Android [7.9.0](https://appmetrica.io/docs/en/sdk/android/changelog-android#s-7-9-0).
- AppMetrica SDK for iOS [5.11.0](https://appmetrica.io/docs/en/sdk/ios/changelog-ios#v-5-11-0).
