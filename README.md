...
- AppMetrica SDK for Android [8.1.0](https://appmetrica.io/docs/en/sdk/android/changelog-android#s-8-1-0).
- AppMetrica SDK for iOS [6.2.0](https://appmetrica.io/docs/en/sdk/ios/changelog-ios#v-6-2-0).
